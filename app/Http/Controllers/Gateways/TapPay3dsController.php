...
use App\Http\Requests\Gateways\TapPay3ds\TapPay3dsRequest;

class TapPay3dsController extends Controller
{
    /**
     * Handle 3DS redirect from TapPay
     *
     * @param TapPay3dsRequest $request
     * @param string $company_key
     * @param string $company_gateway_id
     * @param string $hash
     * @return mixed
     */
    public function index(TapPay3dsRequest $request, string $company_key, string $company_gateway_id, string $hash)
    {
